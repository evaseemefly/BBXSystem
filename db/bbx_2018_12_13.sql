...
--
-- Host: localhost    Database: bbxsystemgis
-- ------------------------------------------------------
...
INSERT INTO `bbx_bbxinfo` VALUES (1,'BBXA','n','小型船舶',100,'s',99);
...
--
-- Table structure for table `bbxgis_bbxgeoinfo`
--

DROP TABLE IF EXISTS `bbxgis_bbxgeoinfo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `bbxgis_bbxgeoinfo` (
  `bsid` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(10) NOT NULL,
  `nowdate` datetime(6) NOT NULL,
  `lat` double NOT NULL,
  ...
  `bid_id` int(11) NOT NULL,
  PRIMARY KEY (`bsid`),
  KEY `bbxgis_bbxgeoinfo_bid_id_157b8333_fk_bbx_bbxinfo_bid` (`bid_id`),
  CONSTRAINT `bbxgis_bbxgeoinfo_bid_id_157b8333_fk_bbx_bbxinfo_bid` FOREIGN KEY (`bid_id`) REFERENCES `bbx_bbxinfo` (`bid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `bbxgis_bbxgeoinfo`
--

LOCK TABLES `bbxgis_bbxgeoinfo` WRITE;
/*!40000 ALTER TABLE `bbxgis_bbxgeoinfo` DISABLE KEYS */;
INSERT INTO `bbxgis_bbxgeoinfo` VALUES (1,'BBXA','2018-12-08 15:11:56.000000',21.64,118.73,30,5.2,1),(2,'BBXA','2018-12-08 15:11:56.000000',20.2,113.04,30,5.2,1),(3,'BBXA','2018-12-08 15:11:56.000000',20.86,111.83,30,5.2,1);
/*!40000 ALTER TABLE `bbxgis_bbxgeoinfo` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(7,'bbx','bbxinfo'),(8,'bbx','bbxspaceinfo'),(9,'bbx','bbxspacetempinfo'),(10,'bbx','hydrologydata'),(11,'bbx','meteorologicaldata'),(12,'bbx','realtimedata'),(13,'bbxgis','bbxgeoinfo'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2018-12-08 03:27:16.964383'),(2,'auth','0001_initial','2018-12-08 03:27:17.175246'),(3,'admin','0001_initial','2018-12-08 03:27:17.241923'),(4,'admin','0002_logentry_remove_auto_add','2018-12-08 03:27:17.251955'),(5,'admin','0003_logentry_add_action_flag_choices','2018-12-08 03:27:17.262784'),(6,'admin','0004_auto_20181015_1013','2018-12-08 03:27:17.272782'),(7,'contenttypes','0002_remove_content_type_name','2018-12-08 03:27:17.320637'),(8,'auth','0002_alter_permission_name_max_length','2018-12-08 03:27:17.346367'),(9,'auth','0003_alter_user_email_max_length','2018-12-08 03:27:17.365266'),(10,'auth','0004_alter_user_username_opts','2018-12-08 03:27:17.373480'),(11,'auth','0005_alter_user_last_login_null','2018-12-08 03:27:17.399962'),(12,'auth','0006_require_contenttypes_0002','2018-12-08 03:27:17.401515'),(13,'auth','0007_alter_validators_add_error_messages','2018-12-08 03:27:17.409317'),(14,'auth','0008_alter_user_username_max_length','2018-12-08 03:27:17.441870'),(15,'auth','0009_alter_user_last_name_max_length','2018-12-08 03:27:17.471929'),(16,'bbx','0001_initial','2018-12-08 03:27:17.668428'),(18,'sessions','0001_initial','2018-12-08 03:27:17.693014'),(20,'bbxgis','0001_initial','2018-12-08 06:48:38.448296'),(21,'bbxgis','0002_auto_20181209_1000','2018-12-09 10:00:14.829589');
...
-- Dump completed on 2018-12-13 15:23:13
